...
<div class="container">
   ...
   <div class="video-list-container">
      ...
      <!-- <div class="list">
         ...
         <h3 class="list-title">Trapezoid</h3>
      </div> -->
...
<footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="footer-info">
              ...
              <p>
                ...
                PH 8002<br><br>
                <strong>Phone:</strong> +63 931 756 2740<br>
                <strong>Email:</strong> info@thesis.com<br>
              </p>
          ...
          <div class="col-lg-4 col-md-6 footer-newsletter">
            ...
            <p>Please subscride to our news letter.</p>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>Intelligent Tutor</span></strong>. All Rights Reserved
      </div>
      <div class="credits">

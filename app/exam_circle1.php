    ...
    <div class="container " style="width: 100%;">
        <div class="page-header">
            <div class="row">
                ...
                <div class="col-md-6">
                    <a href="" class="btn btn-light float-right" title="Guide" data-toggle="modal"
                        data-target="#examGuide" style="padding: 4px;margin: 4px;margin-right: 10px;">
                    ...
                    <tbody>
                        <tr>
                            <form action="config/answerverify1.php" method="POST">
                                ...
                                <input type="text" id="questionID" name="question_id"
                                    value="<?php echo $question_id; ?>" hidden>
                                <input type="text" id="anskey" name="answerkey" value="<?php echo $answerkey; ?>"
                                    hidden>

            ...
            <div id="accordion">
                ...
                <div class="card">
                    ...
                    <div id="faq4" class="collapse" data-parent="#accordion">
                        <div class="card-body">
                           <p style = "text-indent:50px;"> We present the conic sections, a particular class of curves which sometimes
                        ...
                        <p style = "text-indent:50px;"><b>Conic sections</b> (or conics), is a curved formed by a plane passing through a
                        ...
                        <ul style = "text-indent:50px;">
                            <li><b>Circle</b> (Figure 1.1) – is a special case of ellipse in which the plane is perpendicular to the axis of the cone.</li><br>
                            <li><b>Ellipse</b> (Figure 1.1) - when the (tilted) plane intersects only one cone to form a bounded curve</li><br>
                            <li><b>Parabola</b> (Figure 1.2) – the plane is parallel to a generator line of the cone</li><br>
                            <li><b>Hyperbola</b> (Figure 1.3) – the intersection is an unbounded curve and the plane is not parallel to a generator line of the cone and the plane intersects both halves of the cone.</li><br>
                        </ul>
                ...
                <div class="card">
                    ...
                    <div id="faq5" class="collapse" data-parent="#accordion">
                        <div class="card-body">
                            <center>Graphs of Quadratic Equations</center>
                            ...
                            <center><img src="images/lesson6.png" width="700" height="500" /></center>
                        </div>
                    </div>
                </div>
                <div class="card">

...
<body>
        ...
        <div class="pd-10">
            <div class="error-page-wrap text-center">
                ...
                <div class="pt-20 mx-auto max-width-200">
                    <a href="index.php?page=dashboard" class="btn btn-primary btn-block btn-lg">Back To Home</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.php?page=dashboard?id=GTM-NXZMQSS" height="0" width="0"
